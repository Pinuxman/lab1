...
namespace StudentClass
{
    class Program
    {
        ...
        {
            Student student1 = new Student("Иванов", "Иван", "Иванович", "М80", 113, 2023, "C#");
            ...
            Console.WriteLine($"Номер курса: {student1.Course(student1)}");
            ...
            Console.WriteLine($"Номер курса: {student2.Course(student2)}");
